...
body{
/*         background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(3.jpeg); */
	height:100vh ;
...
<body>
	...
	<header>
		...
		<div class='title1'>
			...
			<h2> Team 4: Riya, Tejal, Yash, Mihir, Prabhanjan, Nishant</h2>
			 
		</div>
		
		<div class="t">
		
			<h3> Advisor: Dr. Karen Chen </h3>
		</div>
...
<br>
				Table which gives country wise total defined cases and showing top 10 countries. <br>
				
<img src="733_2.PNG" alt=” TOP 10 COVID AFFECTED COUNTRIES ”  width="650" height="450" align="middle" ></p>

		</div>
		
		<div class="i3">	
				<p>This is a progression of COVID 19 cases spread graph over time. The radius of the circle represents the number of cases and the colors indicate intensity of cases.
				<br>
					<img src="733_3.PNG" alt=” Progression for spread of covid”  width="650" 
				     height="450" align="middle" ></p>
		</div>	
		...
		<p>This visualization represents the number of confirmed cases worldwide (focussed on US).
			<br>
				<img src="733_4.PNG" alt=” Confirmed cases worldwide”  width="650" 
...
<div>
	...
	<div class = "ml">
		<p> We have considered 4 autoregression methods to predict future values of confirmed COVID-19 cases
			<br>
			
			<img src="733_5.PNG" alt=” Progression for spread of covid”  width="1200" 
...
Support Vector Machine: It is well-known for its classification's discriminative power. By maximizing the data between data clusters, this training technique constructs a model by discovering a hyperplane and accurately classifies data. 
			<br>
				<img src="733_6.PNG" alt=” Progression for spread of covid”  width="650" 
     height="450" align="left" >
...
<br>
<img src="733_7.PNG" alt=” Progression for spread of covid”  width="650" 
     height="450" align="left" >
...
<img src="733_8.PNG" alt=” Progression for spread of covid”  width="650" 
     height="450" align="left" >
			</p>
...
<br>
<img src="733_9.PNG" alt=” Progression for spread of covid”  width="650" 
     height="450" align="left" >
			...
			<div class="expr">
				<h3> EXPERMIENTAL RESULTS</h3>
			</div>
			
			<div class="expr1">
			
				<p>Comparing the parameters MAE, MSE and R2 for all the four methods, we observe that the polynomial regression is best fit for our dataset. The reason is that the mean absolute error is less and the coefficient value is higher than other methods[5].
...
The temperature plays a major role in transmission of the covid which can be observed with the below choropleth globe visualization[3]:
					...
					<br>
<img src="733_10.PNG" alt=” Progression for spread of covid”  width="650" 
     height="450" align="left" >
...
<img src="733_11.PNG" alt=” Progression for spread of covid”  width="650" 
     height="450" align="left" ></p>
...
Number of confirmed cases from 8th december 2020 to 12th december 2020.
	...
	<img src="733_12.PNG" alt=” Progression for spread of covid”  width="650" 
...
<img src="733_13.PNG" alt=” Progression for spread of covid”  width="650" 
     height="400" align="left" >
			...
			<div class="con1">
				<p> With data analytics and data mining perspectives, information and communication technology aids in the decision-making process based on historical data. The amount of data accessible is enormous, and acquiring information and making predictions from it is a difficult undertaking. So, using the existing COVID dataset, several methods are applied to the data in order to determine the best accurate approach by varying the MSE, MAE, and R2 parameters.

 

Polynomial Regression is the best approach for predicting instances among other ways since its mean absolute error (MAE) is lower than other methods and R square (coefficient of determination) is near to one. So, for case prediction, chose Polynomial Regression as the best fit model. </p>
			</div>	
...
The goal for the future is to create and implement error-correcting strategies to improve model predictability and accuracy.
	...
	<div class="embed">
		<iframe width="560" height="315" src="https://www.youtube.com/embed/lNChB4ebERw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
